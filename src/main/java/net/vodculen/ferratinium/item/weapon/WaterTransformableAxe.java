...
public class WaterTransformableAxe extends AxeItem {
	private final Item transformedItem;

	public WaterTransformableAxe(ToolMaterial material, int maxCount, float attackDamage, Settings settings, Item transformedItem) {
